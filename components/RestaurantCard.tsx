...
export default function RestaurantCard({ restaurant, index = 0 }: RestaurantCardProps) {
  ...
  return (
    <div
      className={`glass rounded-2xl overflow-hidden card-hover opacity-0 animate-slide-up stagger-${Math.min(index + 1, 5)}`}
    >
      {/* Image/Emoji Header */}
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          ...
          <button
            className="px-4 py-2.5 bg-white border-2 border-gray-200 text-gray-600 rounded-xl hover:border-green-400 hover:bg-green-50 hover:text-green-600 transition-all flex items-center justify-center"
          ...
          <button
            className="px-4 py-2.5 bg-white border-2 border-gray-200 text-gray-600 rounded-xl hover:border-red-400 hover:bg-red-50 hover:text-red-500 transition-all flex items-center justify-center"
